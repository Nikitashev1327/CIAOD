...
public class main{
    ...
    static void first() throws Exception {
        ...
        Lab4.Deque<String> q1 = new Lab4.Deque<String>();
        Lab4.Deque<String> q2 = new Lab4.Deque<String>();

        //java.util.Deque<String> q1 = new java.util.Deque<String>();
        //java.util.Deque<String> q2 = new java.util.Deque<String>();
    ...
    static void second(){
        ...
        Lab4.Deque<Character> deque = new Lab4.Deque<Character>();

        //java.util.Deque<Character> deque = new java.util.Deque<Character>();
        int iter = 0;
    ...
    static void third(){
        ...
        java.util.Stack<Integer> B = new java.util.Stack<>();
        java.util.Stack<Integer> C = new java.util.Stack<>();
    ...
    static void hanoi_tower(java.util.Stack<Integer> A, java.util.Stack<Integer> B, java.util.Stack<Integer> C, int n){
        if(n <= 0){
            return;
        }
    ...
    static void fifth(){
        try(FileReader reader = new FileReader("task5.txt")){
            ...
            Lab4.Deque<Integer> deque = new Lab4.Deque<Integer>();

            //java.util.Deque<Integer> deque = new java.util.Deque<Integer>();
            while((c = reader.read()) > 0){
                if(c == '['){
                    deque.addFirst(c);
                }
    ...
    static void seventh(){
        ...
        //java.util.Deque<Integer> deque = new Deque<Integer>();
